...
const LeftSideBar = () => {
  ...
  return (
    <section className='background-light900_dark200  custom-scrollbar  sticky left-0 top-0 flex h-screen max-h-[1100px] flex-col justify-between overflow-y-auto border-r  px-6 pb-8 pt-28  shadow-light-200  dark:border-dark-400 dark:shadow-none max-sm:hidden lg:w-[266px]'>
        ...
        {sidebarLinks.map(({ imgURL, route, label }) => {
          ...
          return (
            ...
            >
              ...
              />
              <p
                className={` group-hover:font-medium group-hover:text-light-900 dark:text-light-800 max-lg:hidden ${
